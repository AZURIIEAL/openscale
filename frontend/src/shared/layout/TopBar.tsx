...
import { MenuIcon } from '@/shared/design-system/MenuIcon';
...
export function TopBar({ systemStatus, systemStatusLabel, isDark, onToggleDark, onOpenMenu }: TopBarProps) {
  ...
  return (
    <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3.5">
        ...
        <span className="os-kbd os-well hidden px-2 py-1 sm:inline">⌘K</span>
